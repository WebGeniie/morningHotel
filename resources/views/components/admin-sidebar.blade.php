...
<div class="text-left text-sm font-thin mt-2 w-4/5 mx-auto text-gray-200 hidden" id="submenu2">
    <h1 class="cursor-pointer p-2 hover:bg-gray-700 rounded-md mt-1"><a href="/admin/rooms/index">All Rooms</a></h1>
    <h1 class="cursor-pointer p-2 hover:bg-gray-700 rounded-md mt-1"><a href="#">Unavailable Rooms</a></h1>
    <h1 class="cursor-pointer p-2 hover:bg-gray-700 rounded-md mt-1"><a href="#">Available Rooms</a></h1>
</div>
    <hr class="my-2 text-gray-600">
